...
if __name__ == "__main__":
    ...
    #facials=file_paths("C:\\Users\\tusha\\OneDrive\\Desktop\\NON_facial_images")
    facials=file_paths("/tmp/NON_facial_images")
    ...
    for each in facials:
        ...
        create_csvfile(features,"/tmp/reduced_features_nonfacial_data24_test.csv")
